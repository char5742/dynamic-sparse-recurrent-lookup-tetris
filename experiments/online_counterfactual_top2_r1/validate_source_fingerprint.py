...
AUTHORIZED_IMPLEMENTATION_PARENT_COMMIT = "ca0af2af8aa041147658fa4f494d1f26a5dc86a7"
...
SOURCE_SUFFIXES = (".jl", ".toml", ".md", ".json", ".py", ".ps1")
    ...
    for relative in SOURCE_ROOTS:
        ...
        if path.is_file():
            ...
            for directory, directory_names, file_names in os.walk(path, topdown=True, followlinks=False):
                ...
                directory_names[:] = [
                    name for name in directory_names if not is_linked_directory(current / name)
                ]
                paths.update(
                    current / name
